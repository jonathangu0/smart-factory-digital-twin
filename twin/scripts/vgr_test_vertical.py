"""Diagnose VGR vertical axis: same side view, force vertical-only pose."""
import omni.usd
import builtins
...
def main():
    builtins._vgr_test_pose = (0, 2800, 0)  # full vertical only
    ...
    print("vertical-only pose set; side cam active")
