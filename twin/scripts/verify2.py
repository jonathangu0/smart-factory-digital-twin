"""3/4 view at a mid-cycle frame to confirm puck + floating beacon are visible."""
import os
import omni.usd
import omni.timeline
from pxr import Usd, UsdGeom, Gf

SHOT = r"C:/Users/icets/Downloads/digitaltwinsf/twin/shots/cycle_verify.png"
FRAME = 180
...
def main():
    ...
    tl.set_current_time(FRAME / stage.GetTimeCodesPerSecond())
