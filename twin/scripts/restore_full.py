"""Reactivate ALL factory clusters (including inactive ones) and capture overview."""
import os
import omni.usd
from pxr import Usd, UsdGeom, Gf

ROOT = "/World/TrainingFactory/World/Factory/Assembly/Part_5"
SHOT = r"C:/Users/icets/Downloads/digitaltwinsf/twin/shots/factory_whole.png"
...
def main():
    ...
    n = 0
    for c in root.GetAllChildren():        # GetAllChildren includes INACTIVE prims
        if not c.IsActive():
            c.SetActive(True)
            n += 1
    print("reactivated", n, "clusters")
