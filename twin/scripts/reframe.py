"""Pull the overview camera back for a full factory shot."""
import os
import omni.usd
from pxr import Usd, UsdGeom, Gf

SHOT = r"C:/Users/icets/Downloads/digitaltwinsf/twin/shots/factory_04.png"
...
def main():
    ...
    print("eye", [round(v, 2) for v in eye], "center", [round(v, 2) for v in C], "d", round(d, 2))
